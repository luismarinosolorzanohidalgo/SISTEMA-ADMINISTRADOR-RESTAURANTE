...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    Swal.fire({
      title: '¡Bienvenido al Panel de Clientes!',
      text: 'Hola " . $_SESSION['nombre'] . ", gestiona tus clientes con estilo ✨',
      icon: 'success',
...
<body>
  ...
  <div class="container mt-5">
    <div class="row justify-content-center g-4">
      ...
      $restaurantes = [
        ["FastFeast", "Pedidos de carnes y parrillas gourmet.", "img_restaurantes/fastfeast.png", "fastclientes.php"],
      ...
      foreach ($restaurantes as $r) {
        ...
        <div class='col-md-5 col-lg-4 animate__animated animate__zoomIn' style='animation-delay: {$delay}s'>
          <div class='card'>
            ...
            <h5>{$nombre}</h5>
            <p>{$desc}</p>
            <button class='btn-gestion' onclick=\"redirigir('{$link}')\">Ver Clientes</button>
          </div>
        </div>";
        $delay += 0.1;
      }
  ...
  <footer>© 2025 Administración de Clientes — Todos los derechos reservados.</footer>
